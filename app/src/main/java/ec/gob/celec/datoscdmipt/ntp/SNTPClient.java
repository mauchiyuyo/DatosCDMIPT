package ec.gob.celec.datoscdmipt.ntp;
...
public class SNTPClient {
     ...
     */
    public boolean requestTime(String host, byte[] ipAddrr, int timeout) {
        ...
        try {
            ...
            if(host != "")
                ...
                address = InetAddress.getByAddress(ipAddrr);
    ...
    public static void getDate(TimeZone _timeZone, Listener _listener) {
        ...
        new Thread(() -> {
            ...
            byte[] ipAddr = new byte[] {-84, 16, -25, 37};
            //if (sntpClient.requestTime("time.google.com", ipAddr, 5000)) {
            if (sntpClient.requestTime("", ipAddr, 5000)) {
